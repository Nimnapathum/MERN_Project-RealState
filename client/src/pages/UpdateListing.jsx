        ...
        <main className="p-3 max-w-4xl mx-auto">
            ...
            className="flex flex-col sm:flex-row gap-4">
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    type="text" placeholder="Description" className="border p-3 rounded-lg" id="description" maxLength='62' minLength='10' required />
                    <input 
                    onChange={handleChange}
                    ...
                    <div className="flex flex-wrap gap-6">
                        <div className="flex items-center gap-2">
                            <input 
                            type="number" id="bedrooms" min='1' max='10' required className="p-3 border border-gray-300 rounded-lg" 
                            onChange={handleChange}
                        ...
                        <div className="flex items-center gap-2">
                            <input 
                            type="number" id="regularPrice" min='1000' max='10000000' required className="p-3 border border-gray-300 rounded-lg" 
                            onChange={handleChange}
                        ...
                        {formData.offer && (
                            <div className="flex items-center gap-2">
                                <input 
                                type="number" id="discountPrice" min='0' max='70' required className="p-3 border border-gray-300 rounded-lg" 
                                onChange={handleChange}
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <button disabled={loading || uploading} className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-90">
